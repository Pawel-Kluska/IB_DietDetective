        ...
        <div className="App">
                        ...
                        <Flex justifyContent={"flex-start"}>
                            <div>
                                <Text><span style={{
                                    color: "#A0AEC0",
                                    fontSize: 'small'
                                }}>Wskaźnik masy ciała: {summary && user ? calculateBMI(summary.todayWeight, user.height).bmiValue : ''} to {summary && user ? calculateBMI(summary.todayWeight, user.height).bmiCategory : ''}.  <br></br> Dążysz do {summary ? summary.targetWeight : ''}kg</span>
                                </Text>
                                <Text mt="10px" fontSize="xl" fontWeight="bold">Aktualna waga:</Text>
                                <Text>
                        ...
                        <Flex justifyContent={"flex"}>
                            <Flex direction="column" alignItems="center" justifyContent="center">
                                ...
                                <Box sx={miniBox} bgGradient="linear(to-r, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.6))">
                                    <Text fontSize="md" ml="10px"><span
                                        style={{color: "#A0AEC0"}}>Dzienny cel</span></Text>
                                    <Text fontSize="md" fontWeight="bold"
                                          ml="15px">{summary ? `${summary.waterDemand} ml` : ''}</Text>
                                </Box>

                                <Box sx={miniBox} bgGradient="linear(to-r, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.6))">
                                    <Text fontSize="md" ml="10px"><span
                                        style={{color: "#A0AEC0"}}>Osiągnięto</span></Text>
                                    <Text fontSize="md" fontWeight="bold"
                                          ml="15px">{summary ? `${summary.waterToday} ml` : ''}</Text>
                                </Box>
                            </Flex>
            ...
            <Container as="section" maxWidth={"4x1"} py="10px" ml={{base: '5', md: '0'}}>
                <SimpleGrid spacing={10} minChildWidth="250px">
                    ...
                    <Box sx={FirstBox}>
                        <Text sx={summary ? summary.caloriesLeftToday : '' < 0 ? redNumber : ""} fontSize="xl"
                              fontWeight="bold">Pozostało</Text>
                        <Text
                            sx={summary ? summary.caloriesLeftToday : '' < 0 ? redNumber : ""}>{summary ? summary.caloriesLeftToday : ''} kcal</Text>
                    </Box>
                </SimpleGrid>
            </Container>
            ...
            <Container as="section" maxWidth={"2x1"} py="10px" ml={{base: '5', md: '0'}}>
                <SimpleGrid spacing={10} minChildWidth="250px">
                    <Flex sx={ThirdBox} flexDirection="column" alignItems="center">
                        ...
                        <Text>
                            Od ostatniego pomiaru zmiana wynosi: <span
                            style={{color: "green", marginRight: "50px"}}>{weightDifference}kg</span> Ostatni pomiar
                            wykonano: <span style={{color: "green"}}>{currentDate}</span>
                        </Text>
                        <ResponsiveContainer>
                            <AreaChart
                                data={weight}
